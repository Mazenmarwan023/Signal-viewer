...
import time
import threading
from glue_signals import GlueSignalsWindow
import os
...
class SignalViewer(QMainWindow):
    ...
    def initUi(self):
        ...
        container.addWidget(self.controls2,2,1)  # controls 2 in the second row and second column in grid
        ...
        self.setStyleSheet("""
            ...
            QWidget#controls1,#controls2,#graph1,#graph2,#graph3{
    ...
    def create_signal_canvas1(self):
        ...
        plot_widget1 = pg.PlotWidget(title="Signal 1")
    ...
    def create_signal_canvas2(self):
        plot_widget2 = pg.PlotWidget(title="Signal 2")
    ...
    def create_signal_canvas3(self):
        plot_widget3 = pg.PlotWidget(title="Glued signal")
    ...
    def start_animation1(self):
        self.timer1.start(170)  # Start the timer with the desired speed
    ...
    def start_animation2(self):
        self.timer2.start(170)  # Start the timer with the desired speed
    ...
    def plot_glued_signal_with_colors(self, signal1_portion, gap_signal, signal2_portion,glued_signal):
        ...
        # self.canvas3.plot(x1, signal1_portion, pen=pen1)       # Color for signal1
        # self.canvas3.plot(x_gap, gap_signal, pen="r")          # Red for the gap
        # self.canvas3.plot(x2, signal2_portion, pen=pen2)      # Color for signal2
